...
- (void)setCollectionViewDataSourceDelegate:(GDCollectionViewCell *)colVw indexPath:(NSIndexPath *)indexPath
{
    ...
    colVw.imgClr.backgroundColor=[self colorWithHexString:[defaults valueForKey:@"colVwBgClr"]];
    colVw.contentView.backgroundColor=[self colorWithHexString:[defaults valueForKey:@"colVwBgClr"]];

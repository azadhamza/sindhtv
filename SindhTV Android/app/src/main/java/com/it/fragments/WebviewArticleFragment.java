...
public class WebviewArticleFragment extends Fragment {
    ...
    public static WebviewArticleFragment newInstance(Bundle bundle) {
        WebviewArticleFragment fragment = new WebviewArticleFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url_webview = shp.getString("url","");
